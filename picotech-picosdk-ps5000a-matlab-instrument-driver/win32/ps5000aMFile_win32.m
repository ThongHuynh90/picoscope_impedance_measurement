function [methodinfo,structs,enuminfo,ThunkLibName]=ps5000aMFile_win32
%PS5000AMFILE_WIN32 Create structures to define interfaces found in 'ps5000aApi'.

%This function was generated by loadlibrary.m parser version  on Wed Aug 22 15:49:01 2018
%perl options:'ps5000aApi.i -outfile=ps5000aMFile_win32.m'
...
% PICO_STATUS _stdcall ps5000aSetDigitalPort ( int16_t handle , PS5000A_CHANNEL port , int16_t enabled , int16_t logicLevel ); 
fcns.name{fcnNum}='ps5000aSetDigitalPort'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'int16', 'enPS5000AChannel', 'int16', 'int16'};fcnNum=fcnNum+1;
...
% PICO_STATUS _stdcall ps5000aNearestSampleIntervalStateless ( int16_t handle , PS5000A_CHANNEL_FLAGS enabledChannelOrPortFlags , double timeIntervalRequested , PS5000A_DEVICE_RESOLUTION resolution , uint16_t useEts , uint32_t * timebase , double * timeIntervalAvailable ); 
fcns.name{fcnNum}='ps5000aNearestSampleIntervalStateless'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'int16', 'enPS5000AChannelFlags', 'double', 'enPS5000ADeviceResolution', 'uint16', 'uint32Ptr', 'doublePtr'};fcnNum=fcnNum+1;
% PICO_STATUS _stdcall ps5000aGetMinimumTimebaseStateless ( int16_t handle , PS5000A_CHANNEL_FLAGS enabledChannelOrPortFlags , uint32_t * timebase , double * timeInterval , PS5000A_DEVICE_RESOLUTION resolution ); 
fcns.name{fcnNum}='ps5000aGetMinimumTimebaseStateless'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'int16', 'enPS5000AChannelFlags', 'uint32Ptr', 'doublePtr', 'enPS5000ADeviceResolution'};fcnNum=fcnNum+1;
% PICO_STATUS _stdcall ps5000aChannelCombinationsStateless ( int16_t handle , uint32_t * channelOrPortFlagsCombinations , uint32_t * nChannelCombinations , PS5000A_DEVICE_RESOLUTION resolution , uint32_t timebase , int16_t hasDcPowerSupplyConnected ); 
fcns.name{fcnNum}='ps5000aChannelCombinationsStateless'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'int16', 'uint32Ptr', 'uint32Ptr', 'enPS5000ADeviceResolution', 'uint32', 'int16'};fcnNum=fcnNum+1;
...
% PICO_STATUS _stdcall ps5000aSetTriggerChannelPropertiesV2 ( int16_t handle , PS5000A_TRIGGER_CHANNEL_PROPERTIES_V2 * channelProperties , int16_t nChannelProperties , int16_t auxOutputEnable ); 
fcns.name{fcnNum}='ps5000aSetTriggerChannelPropertiesV2'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'int16', 'tPS5000ATriggerChannelPropertiesV2Ptr', 'int16', 'int16'};fcnNum=fcnNum+1;
% PICO_STATUS _stdcall ps5000aSetAutoTriggerMicroSeconds ( int16_t handle , uint64_t autoTriggerMicroseconds ); 
fcns.name{fcnNum}='ps5000aSetAutoTriggerMicroSeconds'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'int16', 'uint64'};fcnNum=fcnNum+1;
...
% PICO_STATUS _stdcall ps5000aSetTriggerChannelConditionsV2 ( int16_t handle , PS5000A_CONDITION * conditions , int16_t nConditions , PS5000A_CONDITIONS_INFO info ); 
fcns.name{fcnNum}='ps5000aSetTriggerChannelConditionsV2'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'int16', 'tPS5000AConditionPtr', 'int16', 'enPS5000AConditionsInfo'};fcnNum=fcnNum+1;
...
% PICO_STATUS _stdcall ps5000aSetTriggerChannelDirectionsV2 ( int16_t handle , PS5000A_DIRECTION * directions , uint16_t nDirections ); 
fcns.name{fcnNum}='ps5000aSetTriggerChannelDirectionsV2'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'int16', 'tPS5000ADirectionPtr', 'uint16'};fcnNum=fcnNum+1;
% PICO_STATUS _stdcall ps5000aSetSimpleTrigger ( int16_t handle , int16_t enable , PS5000A_CHANNEL channel , int16_t threshold , PS5000A_THRESHOLD_DIRECTION direction , uint32_t delay , int16_t autoTrigger_ms ); 
...
% PICO_STATUS _stdcall ps5000aSetTriggerDigitalPortProperties ( int16_t handle , PS5000A_DIGITAL_CHANNEL_DIRECTIONS * directions , int16_t nDirections ); 
fcns.name{fcnNum}='ps5000aSetTriggerDigitalPortProperties'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'int16', 'tPS5000ADigitalChannelDirectionsPtr', 'int16'};fcnNum=fcnNum+1;
% PICO_STATUS _stdcall ps5000aSetPulseWidthDigitalPortProperties ( int16_t handle , PS5000A_DIGITAL_CHANNEL_DIRECTIONS * directions , int16_t nDirections ); 
fcns.name{fcnNum}='ps5000aSetPulseWidthDigitalPortProperties'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'int16', 'tPS5000ADigitalChannelDirectionsPtr', 'int16'};fcnNum=fcnNum+1;
...
% PICO_STATUS _stdcall ps5000aSetPulseWidthQualifierProperties ( int16_t handle , uint32_t lower , uint32_t upper , PS5000A_PULSE_WIDTH_TYPE type ); 
fcns.name{fcnNum}='ps5000aSetPulseWidthQualifierProperties'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'int16', 'uint32', 'uint32', 'enPS5000APulseWidthType'};fcnNum=fcnNum+1;
% PICO_STATUS _stdcall ps5000aSetPulseWidthQualifierConditions ( int16_t handle , PS5000A_CONDITION * conditions , int16_t nConditions , PS5000A_CONDITIONS_INFO info ); 
fcns.name{fcnNum}='ps5000aSetPulseWidthQualifierConditions'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'int16', 'tPS5000AConditionPtr', 'int16', 'enPS5000AConditionsInfo'};fcnNum=fcnNum+1;
% PICO_STATUS _stdcall ps5000aSetPulseWidthQualifierDirections ( int16_t handle , PS5000A_DIRECTION * directions , int16_t nDirections ); 
fcns.name{fcnNum}='ps5000aSetPulseWidthQualifierDirections'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'int16', 'tPS5000ADirectionPtr', 'int16'};fcnNum=fcnNum+1;
...
% PICO_STATUS _stdcall ps5000aSetDataBuffers ( int16_t handle , PS5000A_CHANNEL source , int16_t * bufferMax , int16_t * bufferMin , int32_t bufferLth , uint32_t segmentIndex , PS5000A_RATIO_MODE mode ); 
...
% PICO_STATUS _stdcall ps5000aSetDataBuffer ( int16_t handle , PS5000A_CHANNEL source , int16_t * buffer , int32_t bufferLth , uint32_t segmentIndex , PS5000A_RATIO_MODE mode ); 
...
% PICO_STATUS _stdcall ps5000aSetUnscaledDataBuffers ( int16_t handle , PS5000A_CHANNEL source , int8_t * bufferMax , int8_t * bufferMin , int32_t bufferLth , uint32_t segmentIndex , PS5000A_RATIO_MODE mode ); 
fcns.name{fcnNum}='ps5000aSetUnscaledDataBuffers'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'int16', 'enPS5000AChannel', 'int8Ptr', 'int8Ptr', 'int32', 'uint32', 'enPS5000ARatioMode'};fcnNum=fcnNum+1;
...
% PICO_STATUS _stdcall ps5000aQueryOutputEdgeDetect ( int16_t handle , int16_t * state ); 
fcns.name{fcnNum}='ps5000aQueryOutputEdgeDetect'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'int16', 'int16Ptr'};fcnNum=fcnNum+1;
% PICO_STATUS _stdcall ps5000aSetOutputEdgeDetect ( int16_t handle , int16_t state ); 
fcns.name{fcnNum}='ps5000aSetOutputEdgeDetect'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'int16', 'int16'};fcnNum=fcnNum+1;
% PICO_STATUS _stdcall ps5000aGetScalingValues ( int16_t handle , PS5000A_SCALING_FACTORS_VALUES * scalingValues , int16_t nChannels ); 
fcns.name{fcnNum}='ps5000aGetScalingValues'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'int16', 'tPS5000AScalingFactorsPtr', 'int16'};fcnNum=fcnNum+1;
% PICO_STATUS _stdcall ps5000aCheckForUpdate ( int16_t handle , PICO_VERSION * current , PICO_VERSION * update , uint16_t * updateRequired ); 
fcns.name{fcnNum}='ps5000aCheckForUpdate'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'int16', 'tPicoVersionPtr', 'tPicoVersionPtr', 'uint16Ptr'};fcnNum=fcnNum+1;
% PICO_STATUS _stdcall ps5000aStartFirmwareUpdate ( int16_t handle , void * progress ); 
fcns.name{fcnNum}='ps5000aStartFirmwareUpdate'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'int16', 'voidPtr'};fcnNum=fcnNum+1;
