...
% waveType : 0 (ps5000aEnuminfo.enPS5000AWaveType.PS5000A_SINE)
 ...
 invoke(sigGenGroupObj, 'setSigGenBuiltInSimple', 0);
...
extInThresholdMv 	= 2000;

% Execute device object function(s).
invoke(sigGenGroupObj, 'setSigGenBuiltIn', waveType, increment, dwellTime, ...
...
a = invoke(sigGenGroupObj, 'setSigGenOff');
